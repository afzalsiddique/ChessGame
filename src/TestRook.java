...
public class TestRook {
    ...
    public void test2(){
        ...
        Piece piece1 = new Rook(true, new Spot(4,4));
        board.addPiece(piece1);
        Piece piece2 = new Rook(true, new Spot(5,4));
        Piece piece3 = new Rook(true, new Spot(4,2));
        Piece piece4 = new Rook(true, new Spot(3,4));
        Piece piece5 = new Rook(true, new Spot(4,5));
        board.addPiece(piece2);
        board.addPiece(piece3);
        board.addPiece(piece4);
        board.addPiece(piece5);
